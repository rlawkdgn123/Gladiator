...
{
    [SerializeField] private PlayerCameraScripts.Components m_components = new();
    [SerializeField] private PlayerCameraScripts.CheckOption m_checkOption = new();
    [SerializeField] private Camera m_camera;
    [SerializeField] private PlayerInputHandler m_inputHandler;

    private PlayerCameraScripts.Components Components => m_components;
    private PlayerCameraScripts.CheckOption CheckOptions => m_checkOption;
